...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a class="btn btn-primary" href="{{ route('User.create') }}"> Registrar Usuarios</a>
        </div>
        ...
        <div class="card-body">
            ...
            <table id="TablaUser" class="table table-bordered table-hover text-center">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                ...
                <tbody>
                    ...
                    @foreach ($Users as $User)
                        <tr>
                            ...
                            <form class=" " action="{{ route('User.destroy', $User) }}" method="POST">
...
@section('js')
    ...
    @if (session('info'))
        <script>
            $(document).ready(function() {
                toastr["info"]("Muy bien, el usuario se ha actualizo con exito", "Mensaje de alerta");
                toastr.options = {
                    //primeras opciones
    ...
    @else
        @if (session('info2'))
            <script>
                $(document).ready(function() {
                    toastr["success"]("Muy bien, el usuario se ha agrego con exito.", "Mensaje de alerta");
                    toastr.options = {
                        //primeras opciones
                        "closeButton": false, //boton cerrar
                        "debug": false,
