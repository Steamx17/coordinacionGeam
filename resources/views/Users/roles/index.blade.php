...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table id="Tablaroles" class="table table-bordered table-hover text-center">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">rol</th>
                ...
                <tbody>
                    ...
                    @foreach ($roles as $role)
                        <tr>
                            ...
                            {{--<td width="90px">--}}
                            <td width="90px">
                                <form class=" " action="{{ route('roles.destroy', $role) }}" method="POST">
    ...
    @section('js')
        ...
        @if (session('info'))
            <script>
                $(document).ready(function() {
                    toastr["info"]("Muy bien, lista de roles actualizada con exito", "Mensaje de alerta");
                    toastr.options = {
                        //primeras opciones
        ...
        @else
            @if (session('info2'))
                <script>
                    $(document).ready(function() {
                        toastr["success"]("Muy bien, rol creado con exito.", "Mensaje de alerta");
                        toastr.options = {
                            //primeras opciones
                            "closeButton": false, //boton cerrar
                            "debug": false,
