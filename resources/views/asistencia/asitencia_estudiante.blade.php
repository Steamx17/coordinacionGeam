...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"> Asistencias del alumno @foreach ($estudianteG as $id => $estudianteGx) <b>{{ $estudianteGx->names_students }}</b>  @endforeach</h3>
        </div>
            ...
            <div class="table-responsive">
                <table id="TablaEstudiante" class="table table-bordered table-hover text-center ">
                    ...
                    <tbody>
                        ...
                        @foreach ($Asistencia as $id=> $AsistenciaE)
                            <tr>
                                <td>{{ ++$id }}</td>
                                <td> {{ $AsistenciaE->start . ' / ' . $AsistenciaE->end }}</td>
                                <td>{{ $AsistenciaE->title }}</td>
                                <td>
                                    @if ($AsistenciaE->present == 1)
                                    <span class="btn btn-sm btn-success">Presente</span>
                                @else
                                    <span class="btn btn-sm btn-danger">Ausente</span>
                                @endif
