...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Alumnos registrados en el grupo en @foreach ($nombreGrupo as $nomb)
                    {{ $nomb->name_group }} </h3>
               

            <div class="col-12">
                <a href="{{ route('g.pdf',$nomb->id ) }}" class="btn btn-info float-right" >
                    Generar lista PDF
                </a>
        ...
        <div class="card-body">
            ...
            <table id="TablaEstudiante" class="table table-bordered table-hover projects text-center">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @foreach ($detalle as $key => $detallex)
                        ...
                        <tr>
                            <td> {{ ++$key }}</td>
                            <td> {{ $detallex->identification_students }}</td>
                            <td> {{ $detallex->names_students }}</td>
                            <td> {{ $detallex->name_group }}</td>
