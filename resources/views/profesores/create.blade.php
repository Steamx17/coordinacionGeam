            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('subjects_id', $asignat, 0, ['class' => 'form-control select2', 'id' => 'departamentoadd', 'style' => 'width: 100%;'], [0 => ['disabled', 'hidden']]) !!}
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('status', ['0' => 'Seleccione un estado', 'ACTIVE' => 'ACTIVO', 'INACTIVE' => 'INACTIVO'], 0, ['class' => 'form-control select2', 'id' => 'status', 'style' => 'width: 100%;'], [0 => ['disabled', 'hidden']]) !!}
