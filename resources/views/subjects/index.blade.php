...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Asignaturas Existentes</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a class="btn btn-primary" href="{{ route('subject.create') }}"> Registrar una asignatura</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <!-- <table id="example1" class="table table-bordered table-striped">-->

            <table id="Tablasubjects" class="table table-bordered table-hover text-center">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                ...
                <tbody>
                    @foreach ($subject as $asignatu)

                        <tr>
                            <td> {{ $asignatu->id }}</td>
                            <td> {{ $asignatu->name_subjects }}</td>


                            <td>
                                {{-- <form  action="{{ route('subject.destroy', $asignatu) }}" 
                                        method="POST"> --}}
                                {{-- podria usar la calse btn-sm para hacer los botones mas pequeños --}}
                                <a class="btn btn-info btn-sm" href="{{ route('subject.edit', $asignatu) }}">
...
@section('js')
    ...
    @if (session('info'))
        <script>
            $(document).ready(function() {
                toastr["info"]("Muy bien, la asignatura se ha actualizado con exito", "Mensaje de alerta");
                toastr.options = {
                    //primeras opciones
    ...
    @else
        @if (session('info2'))
            <script>
                $(document).ready(function() {
                    toastr["success"]("Muy bien, la asignatura se ha agregado con exito.", "Mensaje de alerta");
                    toastr.options = {
                        //primeras opciones
                        "closeButton": false, //boton cerrar
                        "debug": false,
            ...
            var idioma = {
                ...
                "editor": {
                    ...
                    "multi": {
                        ...
                        "noMulti": "Este registro puede ser editado individualmente, pero no como parte de un subject."
                    }
                },
